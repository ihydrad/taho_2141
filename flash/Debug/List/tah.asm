...
; 0000 011F             len[0]=TIMER;
	...
	ADD  R30,R26
	ADC  R31,R27
	STS  _len_S0000005000,R30
	STS  _len_S0000005000+1,R31
; 0000 0120             process=0;
	CBI  0x13,1
; 0000 0121             cnt++;
	LDS  R30,_cnt_S0000005000
	SUBI R30,-LOW(1)
	STS  _cnt_S0000005000,R30
; 0000 0122             break;
	RJMP _0x28
; 0000 0123 
; 0000 0124             case 1:
...
; 0000 0127             if((len[1] < (len[0]+300)) && (len[1] > (len[0]-300)))
	...
	LDS  R30,_len_S0000005000
	LDS  R31,_len_S0000005000+1
	SUBI R30,LOW(-300)
	SBCI R31,HIGH(-300)
	CP   R26,R30
	CPC  R27,R31
...
; 0000 0142 
; 0000 0143      if(cnt==10)
	LDS  R26,_cnt_S0000005000
	CPI  R26,LOW(0xA)
	BRNE _0x3B
; 0000 0144        {
; 0000 0145         data=((long)len[0]+(long)len[1]+(long)len[2])/3;
	LDS  R26,_len_S0000005000
	LDS  R27,_len_S0000005000+1
	CLR  R24
	CLR  R25
	__GETW1MN _len_S0000005000,2
	CLR  R22
